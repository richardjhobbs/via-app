...
md += `| \`0x9f783931cedc82c538028fb9be5289a38bc395df\` | Buyer on 1 mainnet purchase (token 17, 2026-03-08, $1.00). Identity TBD: confirm with Richard before classifying | rrg_purchases |\n`;
md += `| \`0x25B22971892B7314c36EC6DCfB5537500d50Ea35\` | Sepolia test buyer (1 row, 2026-03-16). Not in any other table. Treat as external test counterparty | rrg_purchases (sepolia only) |\n`;
md += `| \`0xe3478b0BB1A5084567C319096437924948Be1964\` | Recurring 0.00-USDC paired counterparty in DFW history. Classic operator/relay-fee pattern (likely a permit relayer or paymaster service). Identity TBD: confirm before classifying | observed in DFW history |\n`;
