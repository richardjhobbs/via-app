  ...
  return NextResponse.json({
    ...
    tools: [
      ...
      },
      {
        ...
        category: 'EARN',
        description: 'Join the RRG Marketing Programme — the single referral/affiliate programme for BOTH human creators and AI agents. You earn 10% of the platform share on revenue generated by agents you introduce to RRG. Works by wallet only — no human/agent distinction.',
        params: {
          wallet_address: { type: 'string', required: true, description: 'Your Base wallet (for commission payouts in USDC)' },
          name:           { type: 'string', required: true },
          erc8004_id:     { type: 'number', required: false },
        },
        next: ['log_referral', 'check_my_commissions', 'get_marketing_handbook'],
      },
      {
        name: 'log_referral',
        category: 'EARN',
        description: 'Log an agent you have referred/recruited to RRG. When they take their first action (submit design, make a purchase), you earn 10% of the platform share of any revenue they generate. Must be a registered marketing programme member first.',
        params: {
          your_wallet:          { type: 'string', required: true },
          referred_name:        { type: 'string', required: true },
          referred_wallet:      { type: 'string', required: false },
          referred_erc8004_id:  { type: 'number', required: false },
          notes:                { type: 'string', required: false },
        },
        next: ['check_my_commissions'],
      },
      {
        name: 'check_my_commissions',
        category: 'EARN',
        description: 'Check your marketing/referral commission balance: total earned, pending payouts, paid to date, recent conversions. Wallet-based.',
        params: { wallet_address: { type: 'string', required: true } },
        next: [],
      },
      {
        name: 'get_marketing_handbook',
        category: 'EARN',
        description: 'Get the RRG Marketing Programme handbook — strategies, talking points, referral flow, commission structure. Same programme regardless of whether you are an agent or a human.',
        params: {},
        next: [],
      },
    ],
    ...
    earn_program: {
      name: 'RRG Marketing Programme (a.k.a. Referral Partner Programme)',
      who_can_join: 'Any wallet holder — humans and AI agents. Single programme, no human/agent distinction. Identity is your Base wallet.',
      commission: '10% of the platform share on every sale generated by an agent you referred',
      payout: 'USDC on Base, paid by RRG to your registered wallet',
      flow: [
        '1. Call join_marketing_program with your wallet and name. One-time.',
        '2. Recruit other agents (A2A, Discord, social). When they are about to join, call log_referral with their name / wallet / ERC-8004 ID.',
        '3. When your referred agent makes any purchase or earns any revenue on RRG, a commission row is created automatically (pending).',
        '4. Call check_my_commissions any time to see earnings and pending payouts.',
        '5. Read get_marketing_handbook for strategy and talking points.',
      ],
      synonyms: 'This programme is also called the "referral programme", "affiliate programme", and "partner programme". All refer to the same system.',
    },
