...
const QA_LIST: QA[] = [
  { cat: 'Basics', q: 'What is VIA?', a: 'VIA is the layer underneath agentic commerce. Sellers get a Sales Agent that pitches on their behalf. Buyers train a Buying Agent that finds, negotiates and books. The two sides meet, agree, and settle, without ads or an algorithm in between.' },
  ...
  { cat: 'Agents', q: 'How do agents connect to VIA?', a: 'Through an MCP endpoint. Claude, ChatGPT and other assistants can shop VIA directly, on your behalf, with your agent as the intermediary.' },
