...
export const brandLogin = {
  ...
  brandName: {
    title: 'Brand name',
    content: 'Enter the name your brand will be known by on the platform. This appears on your storefront, in listings, and on social posts. You can update it later in your brand settings.',
  },
  walletChoice: {
    title: 'Wallet setup',
...
export const brandAdmin = {
  ...
  logo: {
    title: 'Brand logo',
    content: 'Square image, JPEG or PNG, max 2 MB. This appears next to your brand name on the storefront, in listings, and in social posts. A simple, recognisable mark works best.',
  },
  banner: {
    title: 'Brand banner',
  ...
  name: {
    title: 'Brand name',
    content: 'Your brand\'s display name. This appears on your storefront, in listings, and social posts. Keep it recognisable and consistent with your existing branding.',
  },
  headline: {
    title: 'Headline',
